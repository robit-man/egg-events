...
| [Bayesian surprise attracts human attention (Vision Research 2009)](https://pmc.ncbi.nlm.nih.gov/articles/PMC2782645/) | surprise is posterior/prior belief change rather than rarity alone | graph familiarity discounts repeated raw novelty while conflicts and reducible gaps retain epistemic value | peer reviewed; adopted |
| [Curiosity-driven Exploration by Self-supervised Prediction (ICML 2017)](https://proceedings.mlr.press/v70/pathak17a.html) | prediction error can provide an intrinsic exploration signal | retain prediction residual, but expose it as one bounded attention component rather than the sole objective | peer reviewed; adopted with guardrail |
| [How to Stay Curious while avoiding Noisy TVs (ICML 2022)](https://proceedings.mlr.press/v162/mavor-parker22a.html) | irreducible/aleatoric uncertainty can trap prediction-error curiosity | discount unstable detections without persistent IDs and ask only about answerable graph gaps | peer reviewed; adopted |
| [Evidence for the Default Network's Role in Spontaneous Cognition (J Neurophysiology 2010)](https://pmc.ncbi.nlm.nih.gov/articles/PMC2904225/) | passive periods support internally directed past/future cognition | add quiet-period replay, not continuous background LLM monologue | peer reviewed; adopted |
| [Default network activity coupled with frontoparietal control supports goal-directed cognition (NeuroImage 2010)](https://pmc.ncbi.nlm.nih.gov/articles/PMC2914129/) | internally generated thought becomes useful through coupling to control | replay only affects outward behavior through live relevance, floor, cooldown, and budget gates | peer reviewed; adopted |
| [Enhanced brain correlations during rest are related to memory for recent experiences (Neuron 2010)](https://pmc.ncbi.nlm.nih.gov/articles/PMC3287976/) | post-experience rest interactions predict memory | replay source-linked recent graph structure in bounded idle windows | peer reviewed; adopted |
| [Generative Agents (UIST 2023)](https://arxiv.org/abs/2304.03442) | observation, planning, and reflection ablations each affect believable behavior | retain an inspectable reflection phase, but ground it in local evidence and avoid free-form autonomous rewriting | peer reviewed; adapted |
