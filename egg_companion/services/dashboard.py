...
<article class="panel"><div class="title">Segmented Objects</div><div id="object-learning-state" class="chips" style="margin-bottom:8px"></div><div id="objects" class="identities"><span class="sub">Hold an object up and identify it naturally.</span></div></article>
